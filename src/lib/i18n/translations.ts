export const translations = {
  en: {
    ...
    // Footer
    footerDescription:
      "Software developer passionate about creating clean, efficient, and user-friendly solutions.",
    ...
    projectMinishell:
      "A simple shell implementation with basic command execution and piping",
    projectTranscendence:
      "Real-time multiplayer Pong game with user authentication and chat",
    ...
    TailwindCSS:
      "Creating responsive and beautiful interfaces with utility classes",
    ...
    TypeScript:
      "Adding type safety and modern features to JavaScript development",
    Docker:
  ...
  fr: {
    ...
    skillsSubtitle:
      "Voici les technologies et langages de programmation dans lesquels je me spécialise. Je suis constamment en train d'apprendre et d'élargir mes compétences.",
    ...
    // Footer
    footerDescription:
      "Développeur logiciel passionné par la création de solutions propres, efficaces et conviviales.",
    ...
    // Project descriptions
    projectMinishell:
      "Une implémentation simple de shell avec exécution de commandes de base et piping",
    projectTranscendence:
      "Jeu Pong multijoueur en temps réel avec authentification utilisateur et chat",
    projectSoLong:
      "Jeu 2D où le joueur collecte des objets et atteint la sortie",
    projectCub3D: "Jeu de raycasting 3D inspiré de Wolfenstein 3D",

    // Skills descriptions
    React:
      "Création d'interfaces utilisateur modernes et interactives avec React et Next.js",
    TailwindCSS:
      "Création d'interfaces réactives et belles avec des classes utilitaires",
    ...
    TypeScript:
      "Ajout de sécurité de type et de fonctionnalités modernes au développement JavaScript",
    Docker:
      "Conteneurisation des applications pour un développement et un déploiement cohérents",

    namePlaceholder: "jean dupont",
    emailPlaceholder: "jeandupont@mail.com",
    messagePlaceholder:
      "Bonjour Mohamed, j'ai une opportunité de stage pour vous !",
