...
export const Hero = () => {
  ...
  return (
    <Section className="relative  flex justify-center items-start md:flex-row md:justify-between md:px-8 lg:px-12 xl:px-16">
      ...
      {/* Content */}
      <div className="flex flex-col-reverse lg:flex-row-reverse lg:gap-4 lg:justify-start px-48 mt-32">
