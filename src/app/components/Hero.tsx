...
export const Hero = () => {
    return (
        <Section className="flex flex-col-reverse justify-center items-center min-h-screen xl:max-h-3.5 md:flex-row md:justify-between md:items-center md:px-8 lg:px-12 xl:px-16 2xl:px-24">
            <div className="w-full text-center mt-8 mb-12 md:text-left md:w-1/2 md:mt-0 md:mb-0 md:pr-4 lg:pr-8 xl:pr-12">
                ...
                <div className="flex items-center justify-center md:justify-start gap-4 mb-6">
                    <button className="bg-primary text-white px-3 py-2 md:px-4 hover:ring-2 ring-ring md:py-3 lg:px-5 lg:py-3 rounded-lg font-poppins font-semibold transition-colors duration-200 hover:bg-primary/90 border-2 border-border">
                        contact me
                        <ArrowRightIcon className="inline-block ml-2" />
                    </button>
                    <button className="bg-card px-3 py-2 md:px-4 md:py-3 lg:px-5 lg:py-3 rounded-lg font-poppins font-semibold transition-colors duration-200  hover:ring-2 ring-ring hover:bg-card/90 border-2 border-border">
                        my resume
