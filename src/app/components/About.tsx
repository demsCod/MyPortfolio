    ...
    return (
        <div className="h-screen max-w-5/6 flex  px-10  max-w-5/6 flex-col ">
            <div className="h-full items-center justify-center ">
                <img src="https://avatars.githubusercontent.com/u/151725068?v=4" alt="Mohamed Dembele" className="w-full h-1/2  mt-5 object-cover rounded-xl border-1 border-primary shadow-xl"  
                        />
                <h1 className="font-montserrat font-bold mt-5 mb-5 text-3xl">
                    ABOUT
                </h1>
                <hr className="border-t-2 border-primary w-full mx-auto my-4" />
