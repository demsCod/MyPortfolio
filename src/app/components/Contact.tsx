          ...
          <form className="w-full " onSubmit={handleSubmit}>
            <div className="flex flex-col sm:flex-row sm:gap-4 mb-4 sm:mb-6">
              ...
              <div className="relative w-full  group mb-4 sm:mb-0">
                <label
                  htmlFor="name"
                  className="block text-sm md:text-base text-foreground/70 mb-1.5 font-medium"
                >
                  {t("name")}
                </label>
                <input
                  type="text"
                  id="name"
                  className="font-poppins block w-full py-2 px-3 bg-transparent border-0 border-b-4 border-border rounded-t-md appearance-none focus:outline-none focus:border-primary text-sm md:text-base"
          ...
          <div className="w-full  mt-10 lg:mt-0">
            <div className="bg-card p-6 rounded-xl border justify-center  justify-items-center font-poppins border-border/50 overflow-x-auto">
              ...
              <div className="flex flex-wrap justify-center  gap-4">
                ...
                >
                  <svg
                    className="w-5 h-5 mr-2 text-foreground group-hover:text-primary"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
